            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                  <Link className="nav-link active" aria-current="page" to={`/`} style={{ color: props.mode === 'dark' ? props.color.whiteText : props.color.blackText }}>Home</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to={`/about`} style={{ color: props.mode === 'dark' ? props.color.whiteText : props.color.blackText }}>About</Link>
                </li>
              </ul>
